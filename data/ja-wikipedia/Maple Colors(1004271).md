Maple Colors (PC)  Maple Colors 〜決戦は学園祭!〜(PS2)  |  ジャンル  |  恋愛フィールドADV   
---|---  
対応機種  |  Windows 98/Me/2000/XP  PlayStation 2   
発売元  |  CROSSNET  (PC)  角川書店  (PS2)   
発売日  |  2003年7月25日 (PC)  2005年3月31日 (PS2)   
レイティング  |  18禁 (PC)  CERO 15 (PS2)   
コンテンツアイコン  |  セクシャル、犯罪   
キャラクター名設定  |  名前のみ可 (PC)  フルネーム可(PS2)   
エンディング数  |  6   
セーブファイル数  |  30 (PS2)   
...
CGモード  |  あり   
音楽モード  |  あり   
回想モード  |  あり (PC)  ミニゲームのみ (PS2)   
メッセージスキップ  |  なし (PC)  あり (PS2)   
オートモード  |  なし (PC)  あり (PS2)   
テンプレートを表示  
