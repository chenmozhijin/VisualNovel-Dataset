...
（  このテンプレートの使い方  ）  
出典検索  ?  :  "BALDRHEAD"  –  ニュース  **·** 書籍  **·** スカラー  **·** CiNii  **·**
J-STAGE  **·** NDL  **·** dlib.jp  **·** ジャパンサーチ  **·** TWL  _( 2022年11月  ) _  
---|---  
...
##  脚注
  ...
  1. ** ^  ** BALDR BULLET "REVELLION"の開発は戯画であり、TEAM BALDRHEADのクレジットはない。 
  2. ** ^  ** BALDR SKY ZEROの開発は戯画であり、TEAM BALDRHEADのクレジットはない。 
  3. ** ^  ** BALDR SKY ZERO 2の開発は戯画であり、TEAM BALDRHEADのクレジットはない。 
