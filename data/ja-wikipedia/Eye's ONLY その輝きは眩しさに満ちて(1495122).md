eye's ONLY その輝きは眩しさに満ちて  ジャンル  |  アニメーション  恋愛アドベンチャーゲーム   
---|---  
...
ゲームシステムこそ典型的なコマンド選択型であるものの、400カット超かつ総動画枚数8000枚超を費やしたアニメーション処理は総計1時間超  [  2  ]
...
##  脚注
  ...
  1. ** ^  ** ただし、登録されないシーンがある。 
  2. ** ^  ** Win版のパッケージ裏の表記より。なお、DVDPG版のパッケージでは総計アニメーション処理が総計90分間超、DL版の配信元では総動画枚数が4000枚である旨がそれぞれ表記されているなど、Win版とのブレが生じている。 
